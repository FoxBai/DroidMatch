...
- [基础音乐管理](docs/basic-music.md)：音频列表、[歌曲信息与搜索](docs/music-metadata.md)、排序、时长、[系统封面](docs/music-artwork.md)、按需播放/暂停/定位、批量导出和原生面板/Finder 导入；Android 提供实时音乐授权入口，播放真机兼容性待验证。
