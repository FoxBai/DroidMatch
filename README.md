...
4. 真机测试按 [docs/m1-testing-guide.md](docs/m1-testing-guide.md) 运行完整 M1 退出门槛测试。
5. 每次推送前更新相关 README，让下一位接手者不用从 commit diff 里猜项目状态。
