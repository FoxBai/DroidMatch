...
当前支持 download 方向的 receiver-paced 单流 open/chunk/ack smoke、活动 download cancel/pause、带 source fingerprint 的非 0 offset resume 请求，以及 app-sandbox fresh upload；SAF/MediaStore upload、upload resume、多流调度、自动断线恢复队列和完整真机传输矩阵仍会继续收口。
