...
- [Basic Music](basic-music.md) adds a fourth Media section with bounded audio
  ...
  coverage exists; physical music behavior is unverified. Playback, artwork, and
  artist/album indexing remain later work. No existing M1 gate is newly passed.
...
As of 2026-09-06, `fixtures/m1-runs/` contains:
- 90 test result logs
