...
- **Structural debt remains:** the scheduler public contract, RPC one-shot primitive, and Android provider upload/download I/O state machines have been extracted, but four production monoliths remain frozen behind explicit non-growth ceilings; see [Structural Debt Baseline](technical-debt.md)
