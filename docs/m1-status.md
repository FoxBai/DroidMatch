...
- [Basic Music](basic-music.md) adds a fourth Media section with bounded audio
  ...
  artwork compatibility and artist/album indexing remain open. [Bounded Music artwork](music-artwork.md) now reuses row/preview requests with live audio access, pre-decode budgets and native placeholders; API 29+ provider output remains physically unverified. No existing M1 gate is newly passed.
