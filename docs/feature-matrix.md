...
| App list and APK install | Optional | Improved | Required | Scoped launcher metadata, search/sort and explicit sharing plus [single-APK system-confirmed installation](apk-installation.md) are implemented locally. Permitted APK export, channel review and device validation remain open; see [Application Library](application-library.md). |
