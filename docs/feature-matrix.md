...
| Music management | Optional | Required | Required | Basic list/search/sort/duration/import/export, live audio authorization, and native play/pause/seek are implemented with local evidence. Artwork and artist/album indexing remain later work; device/codec validation is open. |
