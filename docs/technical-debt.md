...
4. **Mac async router (default-budget reached):** `AsyncRpcRoutingState` owns
   ...
   retry/progress/terminal ordering bridge. The actor-confined
   ...
   761-line scheduler actor retains runtime queue/task/timer and
   persistence-write ownership.
