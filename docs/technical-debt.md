...
<!-- test-inventory swift=501 android-unit=296 -->
...
501 项 Swift 测试与 296 项 Android JVM 测试；这些只属于
离线回归，不新增真机或发布签名证据。
...
`test-run-m1-throughput-gate.sh` at 800 lines, and the inventory is 501/296. Counts and
