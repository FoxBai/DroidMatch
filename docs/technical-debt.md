...
<!-- test-inventory swift=501 android-unit=283 -->
...
501 Swift tests and 283 Android JVM tests; these offline regressions add no
physical-device or release-signing evidence.
The takeover baseline therefore names 501 Swift tests and 283 Android unit tests/lint;
