...
4. **Mac async router (default-budget reached):** `AsyncRpcRoutingState` owns
   ...
   738-line scheduler actor retains live record/queue, task/timer,
   persistence-write, broadcast, and executor-unwind ownership.
