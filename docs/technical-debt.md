...
<!-- test-inventory swift=501 android-unit=286 -->
...
501 Swift tests and 286 Android JVM tests; these offline regressions add no
...
The takeover baseline therefore names 501 Swift tests and 286 Android unit tests/lint;
...
501 项 Swift 测试与 286 项 Android JVM 测试；这些只属于
离线回归，不新增真机或发布签名证据。
...
`test-run-m1-throughput-gate.sh` at 800 lines, and the inventory is 501/286. Counts and
