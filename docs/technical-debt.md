...
behavior; native UI uses synthetic entries. Audio playback/indexing refinements
and actual device observations remain open. See [Basic Music](basic-music.md).
